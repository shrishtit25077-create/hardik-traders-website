    ...
    <div className="bg-bg-800 min-h-screen text-text-primary flex flex-col justify-between">
      ...
      <main className="max-w-[1400px] w-full mx-auto px-6 md:px-10 py-16 flex-grow mt-[72px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          {/* Call to Action Card */}
          <div className="lg:col-span-2 bg-bg-900 border border-border-subtle hover:border-ice-blue/30 p-8 flex flex-col md:flex-row items-center justify-between gap-8 rounded-[28px] shadow-[0_20px_60px_rgba(0,0,0,0.06)] relative overflow-hidden group transition-all duration-300">

...
import { Wrench, Phone, Mail, MapPin, ArrowUpRight, Instagram, Linkedin, Youtube } from 'lucide-react';
...
const LINKS   = [{ name: 'Home', href: '#home' }, { name: 'About', href: '#about' }, { name: 'Products', href: '#products' }, { name: 'Brands', href: '#brands' }, { name: 'Contact', href: '#contact' }];
...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: '#141414', color: '#777' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-[13px] leading-relaxed mb-6">
              Authorized dealer for 25+ global industrial brands. Quality tools and engineering solutions across India.
            </p>
            <div className="flex gap-2.5">
              {SOCIALS.map(({ Icon, href }, i) => (
                <a key={i} href={href}
                  className="w-8 h-8 rounded-lg flex items-center justify-center border transition-all"
                  style={{ borderColor: '#272727', color: '#666' }}
                  ...
                  onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.borderColor = '#272727'; e.currentTarget.style.color = '#666'; }}
                >
                  <Icon size={15} />
                </a>
              ))}
          ...
          {/* Categories */}
          <div>
            <h4 className="text-white text-[11px] font-black uppercase tracking-widest mb-5">Categories</h4>
            <ul className="space-y-2.5">
              {CATS.map(c => (
                <li key={c}>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white text-[11px] font-black uppercase tracking-widest mb-5">Contact</h4>
            <ul className="space-y-4 text-[13px]">
              {[
                { Icon: MapPin, text: 'Industrial Area, Engineering Zone\nCity, State – 000000' },
            ...
            <div className="mt-5 pt-5" style={{ borderTop: '1px solid #222' }}>
              ...
              <div className="flex justify-between text-[13px]">
                <span>Mon – Sat</span><span className="text-white">9AM – 7PM</span>
              </div>
              <div className="flex justify-between text-[13px] mt-1.5">
                <span>Sunday</span><span style={{ color: 'var(--red)' }}>Closed</span>
              </div>
            </div>
          </div>
